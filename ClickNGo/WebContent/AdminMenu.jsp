...
<body <%out.print("style=\"background-image:url(holiday2.jpg);background-position:center;background-repeat:repeat y;text-align:right;background-color:#E6E6FA\""); %>>
    ...
    <h2  <%out.print("style=\"margin-top:10px; font-size:40px;color:#444444;margin-right:20px\""); %>>Admin Menu</h2><br>
	<h1  <%out.print("style=\"margin-top:10px; font-size:30px;color:#444444;margin-right:40px\""); %>>Select an option</h1>
	<p <%out.print("style=\"margin-top:30px\""); %>><input type = "button" value = "Register Admin" onclick = "window.location.href = 'adminreg.jsp' " <%out.print("style=\"background-color:#DDDDDD;border-radius:5px;font-size:25px;margin-right:40px;\""); %>></p>
	<p <%out.print("style=\"margin-top:30px\""); %>><input type = "button" value = "Add Holiday" onclick = "window.location.href = 'addHoliday.jsp' " <%out.print("style=\"background-color:#DDDDDD;border-radius:5px;font-size:25px;margin-right:40px;\""); %>></p>
